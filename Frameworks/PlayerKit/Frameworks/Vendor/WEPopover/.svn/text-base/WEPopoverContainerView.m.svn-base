...
/// modified by lucky.li, 2015-03-26
#define Modified_For_PlayerKit  1

#if Modified_For_PlayerKit
#import "UIImage+pk.h"
#endif
...
#if Modified_For_PlayerKit
        if (!theImage) {
            theImage = [UIImage imageInPKBundleWithName:properties.bgImageName];
        }
#endif
...
#if Modified_For_PlayerKit
    if (!upArrowImage) {
        upArrowImage = [UIImage imageInPKBundleWithName:properties.upArrowImageName];
    }
    if (!downArrowImage) {
        downArrowImage = [UIImage imageInPKBundleWithName:properties.downArrowImageName];
    }
    if (!leftArrowImage) {
        leftArrowImage = [UIImage imageInPKBundleWithName:properties.leftArrowImageName];
    }
    if (!rightArrowImage) {
        rightArrowImage = [UIImage imageInPKBundleWithName:properties.rightArrowImageName];
    }
#endif
